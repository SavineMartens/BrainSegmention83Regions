...
#SBATCH --gres=gpu:1
#SBATCH -t 300:00:00
#SBATCH -o /media/data/smartens/output/ADNIskull_200_out_%j.log
#SBATCH -e /media/data/smartens/output/ADNIskull_200_error_%j.log
...
# run python script
python /media/data/smartens/code/MainLobes2.py ADNIskull_200 0.001 ${MY_TMP_DIR} ${SLURM_JOB_ID}
...
#chown -R 1020:1014 /media/data/smartens/data/datasize176_208_160/hyperparametertuning/ADNIskull_200/${SLURM_JOB_ID}*/
