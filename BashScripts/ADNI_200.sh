...
#SBATCH --gres=gpu:1
#SBATCH -t 300:00:00
#SBATCH -o /media/data/smartens/output/ADNI_200_out_%j.log
#SBATCH -e /media/data/smartens/output/ADNI_200_error_%j.log
...
# run python script
python /media/data/smartens/code/MainLobes2.py ADNI_200 0.001 ${MY_TMP_DIR} ${SLURM_JOB_ID}
