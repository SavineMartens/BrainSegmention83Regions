...
#SBATCH --gres=gpu:1
#SBATCH -t 300:00:00
#SBATCH -o /media/data/smartens/output/TF2a_ADNI_200_out_%j.log
#SBATCH -e /media/data/smartens/output/TF2a_ADNI_200_error_%j.log
...
# run python script
python /media/data/smartens/code/TransferLearning2a.py ADNI_200 Frontal Temporal ${MY_TMP_DIR} ${SLURM_JOB_ID}

#cp /media/data/smartens/output/TF2a_ADNI_200_out_${SLURM_JOB_ID}.log /media/data/smartens/results/${SLURM_JOB_ID}*/
#cp /media/data/smartens/output/TF2a_ADNI_200_error_${SLURM_JOB_ID}.log /media/data/smartens/results/${SLURM_JOB_ID}*/
