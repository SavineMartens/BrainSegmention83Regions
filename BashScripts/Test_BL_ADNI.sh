...
#SBATCH --gres=gpu:1
#SBATCH -t 6:00:00
#SBATCH -o /media/data/smartens/output/Test_BL_ADNI_out_%j.log
#SBATCH -e /media/data/smartens/output/Test_BL_ADNI_error_%j.log
...
# run python script
python /media/data/smartens/code/Testing.py BL_ADNI 0.001 Hammers ${MY_TMP_DIR} ${SLURM_JOB_ID}

#cp /media/data/smartens/output/Test_BL_ADNI_out_${SLURM_JOB_ID}.log /media/data/smartens/results/${SLURM_JOB_ID}*/
#cp /media/data/smartens/output/Test_BL_ADNI_error_${SLURM_JOB_ID}.log /media/data/smartens/results/${SLURM_JOB_ID}*/
