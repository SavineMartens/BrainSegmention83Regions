...
#SBATCH --gres=gpu:1
#SBATCH -t 6:00:00
#SBATCH -o /media/data/smartens/output/Test_TF_ADNI_out_%j.log
#SBATCH -e /media/data/smartens/output/Test_TF_ADNI_error_%j.log
...
# run python script
python /media/data/smartens/code/TF_Testing.py ADNI_200 Frontal Temporal ADNI ${MY_TMP_DIR} ${SLURM_JOB_ID}

#cp /media/data/smartens/output/Test_TF_ADNI_out_${SLURM_JOB_ID}.log /media/data/smartens/results/${SLURM_JOB_ID}*/
#cp /media/data/smartens/output/Test_TF_ADNI_error_${SLURM_JOB_ID}.log /media/data/smartens/results/${SLURM_JOB_ID}*/
